...
import java.util.Iterator;
    ...
    public class BankingApplication {
                        ...
                        if (input.length == 6) {
                            ...
                            while (true) {
                                ...
                                switch (/* 4. Get the command */ Command.toStr(input[0].toUpperCase())) {
                                    case CREATE: {
                                        if (input.length == 5) {
                                            String Accname = input[1];
                                            String accType = input[2];
                                            //Did not make a method for isValid checking zip code exists.
                                            zip = Long.parseLong(input[3]);
                                            double minAmt = Double.parseDouble(input[4]);
                                            account = new Account(12006, accType, zip, minAmt);
                                            accountHolder = new AccountHolder(Accname, account);
                                            System.out.println(
                                    ...
                                    case CHECKS: {
                                        if (input.length == 3) {
                                            list = account.getAccountTransactionsList().getChequeList();
                                            myBank.printList2(list);
                                        } else
                                    ...
                                    case DEPOSITS: {
                                        if (input.length == 1) {
                                            list = account.getAccountTransactionsList().getDepositsList();
                                            myBank.printList3(list);
                                        } else
                                            System.out.println("Please Enter the Start and End Range");
                                        break;
                                    }
        ...
        public void printList2 (List < Cheque > list) {
            ...
            if (list.isEmpty())
                ...
                System.out.println("Date\t\t Transaction Type\t Amount");
                if (it != null) {
                    for (Iterator<Cheque> it1 = it; it1.hasNext(); ) {
                        Cheque chk = it1.next();
        ...
        public void printList3 (List < Deposits > list) {
            Iterator<Deposits> dt = list.iterator();
            if (list.isEmpty())
                System.out.println("No Transactions");
            else {
                System.out.println("Date\t\t Transaction Type\t Amount");
                if (dt != null) {
                    for (Iterator<Deposits> dt1 = dt; dt1.hasNext(); ) {
                        Deposits dhk = dt1.next();
